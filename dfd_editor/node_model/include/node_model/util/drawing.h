...
#ifndef IMDFD_DFD_EDITOR_NODE_MODEL_INCLUDE_NODE_MODEL_UTIL_DRAWING_H_
    ...
    IconType type, bool filled, ImU32 color, ImU32 innerColor) {
  {
    ...
    if (type == IconType::Flow) {
      ...
      drawList->PathBezierCubicCurveTo(ImVec2(left, bottom),
          ImVec2(left, bottom), ImVec2(left, bottom) - ImVec2(0, rounding));
      ...
      if (type == IconType::Grid) {
        ...
        const auto baseTl = ImVec2(
            floorf(rect_center_x - w * 2.5f), floorf(rect_center_y - w * 2.5f));
...
#endif // IMDFD_DFD_EDITOR_NODE_MODEL_INCLUDE_NODE_MODEL_UTIL_DRAWING_H_
